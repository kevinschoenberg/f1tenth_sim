...
#include "f1tenth_simulator/single_track_drift_kinematics.hpp"
...
public:
    ...
    RacecarSimulator(): im_server("racecar_sim") {
        ...
        state = {.x=0, .y=0, .theta=0, .velocity=0, .steer_angle=0.0, .angular_velocity=0.0, .slip_angle=0.0, .angular_speed_f=0.0, .angular_speed_r=0.0 ,.st_dyn=false};
        accel = 0.0;
        steer_angle_vel = 0.0;
        desired_speed = 0.0;
