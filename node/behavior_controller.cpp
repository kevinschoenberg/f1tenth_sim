...
public:
    BehaviorController() {
        ...
        // ***Add mux index for new planner here***
        n.getParam("lsdnode_mux_idx", lsdnode_mux_idx);
        ...
        // ***Add button index for new planner here***
        n.getParam("lsdnode_button_idx", lsdnode_button_idx);
        ...
        // ***Add key char for new planner here***
        n.getParam("lsdnode_key_char", lsdnode_key_char);
    ...
    void joy_callback(const sensor_msgs::Joy & msg) {
        ...
        if (msg.buttons[lsdnode_button_idx]) {
        //	new planner
          toggle_mux(lsdnode_mux_idx, "LSDNode");
        }
